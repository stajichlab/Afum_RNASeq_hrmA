...
write.csv(txi.kallisto$abundance,"reports/kallisto_single_hypoxiaonly.TPM.csv")
write.csv(txi.kallisto$counts,"reports/kallisto_single_hypoxiaonly.counts.csv")
